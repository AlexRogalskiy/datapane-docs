...
![](.gitbook/assets/email\_recipients.png)
...
![](.gitbook/assets/1\_ezfj3xujcwb0v2r45vzngg.png)
...
![](<.gitbook/assets/screenshot-2021-05-04-at-19.57.47 (1).png>)
...
Many users were using our Markdown component to build a table, and we looked at building our own, before settling on supporting Pandas HTML tables. This allows us to support [Pandas Styling](https://pandas.pydata.org/pandas-docs/stable/user\_guide/style.html) and is a natural fit for our HTML reports, making it simple to build beautiful styled tables like this:
